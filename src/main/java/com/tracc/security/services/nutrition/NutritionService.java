package com.tracc.security.services.nutrition;

import com.tracc.exceptions.nutrition.NutritionNotFoundException;
import com.tracc.models.nutrition.*;
import com.tracc.payload.request.nutrition.FoodRequest;
import com.tracc.payload.request.nutrition.NutritionRequest;
import com.tracc.payload.request.nutrition.SupplementRequest;
import com.tracc.repository.nutrition.NutritionCategoryRepository;
import com.tracc.repository.nutrition.NutritionRepository;
...
public class NutritionService {
    ...
    public List<Nutrition> findAllNutrition() {
        ...
        return nutritionRepository.getAllNutrition(userId, sort);
    }
    ...
    private Nutrition parseNutritionRequest(NutritionRequest nutritionRequest) {
        ...
        if(nutritionRequest instanceof FoodRequest) {
            ...
            System.out.println("Nutrition is");
            System.out.println(((Food) nutrition).getCalories());
